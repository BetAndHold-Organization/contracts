...
const CSV_FILE = "../../contracts/tickets-crash-36h-2026-05-01-00-58-54.csv";
const NUM_WINNERS = 5;
...
async function main() {
  ...
  console.log("══════════════════════════════════════════════════════════════");
  console.log("  CRASH LOTTERY 36H — 5 WINNERS");
  console.log("══════════════════════════════════════════════════════════════");
  console.log("");
  ...
  const resultPath = new URL("lottery-crash-36h-result.json", deploymentsDir);
